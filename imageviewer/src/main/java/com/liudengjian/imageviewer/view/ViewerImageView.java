...
import com.liudengjian.imageviewer.view.gesture.ImageGesturesAttacher;
...
public class ViewerImageView extends ImageView implements TransformAttacher.TransStateChangeListener, View.OnLayoutChangeListener {
    ...
    public ViewerImageView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ViewerImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(21)
    public ViewerImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
