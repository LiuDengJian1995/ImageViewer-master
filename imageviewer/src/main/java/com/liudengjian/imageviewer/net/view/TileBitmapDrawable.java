package com.liudengjian.imageviewer.net.view;
...
import com.liudengjian.imageviewer.util.MathUtils;
...
public class TileBitmapDrawable extends Drawable {
    ...
    private static final class InitializationTask extends AsyncTask<Object, Void, Object> {
        ...
        protected Object doInBackground(Object... params) {
            ...
            final float minScale = Math.min(ImageViewerUtil.getScreenWidth() / (float) decoder.getWidth(), ImageViewerUtil.getScreenHeight() / (float) decoder.getHeight());
            ...
            try {
                ...
                if (null == bitmap) {
                    //下载的图片有问题,将其删掉
                    ImageViewerUtil.deleteFiles((String) params[0]);
