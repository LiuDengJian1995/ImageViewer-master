package com.liudengjian.imageviewer.evaluator;
...
public class RectFEvaluator implements TypeEvaluator<RectF> {
     ...
     * whenever possible.
     *  @中文 构建一个RectEvaluator返回每个调用新的正确评价。
     * 避免为每个评估调用创建对象，
     * {@link android.animation.RectEvaluator#RectEvaluator(Rect)}应使用尽可能。
     */
